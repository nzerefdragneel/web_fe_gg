            ...
            <div className="flex flex-col items-start gap-2 px-2 py-2 my-5 mr-5 -ml-36">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center ">
                    <div className="mr-4 ml-2">
                        ...
                        <div className="text-base mt-3 text-neutral-600">
                            ...
                            which empowers your institution with simple, safer,
                            collaborative tools.
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-4 mt-24 items-start">
                    ...
                    <div className="text-base text-neutral-600">
                        Classroom is designed with feedback from the educational
                        community, always building new features and
                        functionality that lets educators focus on teaching and
