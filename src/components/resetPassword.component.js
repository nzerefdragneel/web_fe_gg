                    ...
                    <div className="flex flex-col flex-wrap">
                        <div className="mr-4 ml-4">
                            ...
                            <div className="text-base mt-3 text-neutral-600">
                                Classroom helps educators create engaging
                                learning experiences they can personalize,
                                manage, and measure. Classroom is a Workspace
                                for Education, which empowers your institution
                                with simple, safer, collaborative tools.
                            </div>
                        </div>
                    </div>
