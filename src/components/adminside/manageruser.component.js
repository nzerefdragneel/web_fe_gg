                    ...
                    <div className="page-header">
                        <div className="flex flex-wrap items-center">
                            <div className=" flex-grow max-w-full flex-1 px-4">
                                <div className="mt-3">
                                    <h3 className="mb-4 float-left mt-2 text-dark-green">
                                        Manager User
                                    </h3>
                                    {/* <NavLink
                to="/staff/add"
                                                        ...
                                                        <tr key={user.id}>
                                                            ...
                                                            <td>
                                                                <div className="actions">
                                                                    {" "}
                                                                    <div
                                                                        className={`inline-block text-white align-middle text-center select-none font-normal whitespace-no-wrap rounded  no-underline py-1 px-2 leading-tight text-xs  ${
                                                                            user.active ===
                                                                            true
                                                                                ? "bg-dark-green"
                                                                                : "bg-error-color"
