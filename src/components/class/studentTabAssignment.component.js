...
export function StudentTabAssignment({ id }) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                const res = await gradeService.getSingleStudentScore(
                    id,
                    userId
                );
            ...
            <div className="grid grid-flow-row-dense gap-2 mx-40 my-4">
                ...
                {!loading &&
                    ...
                    listAssignments.map((value) => (
                        <div className="flex flex-col px-2 py-3 justify-end shadow-md w-full bg-slate-50 rounded my-2">
                            ...
                            >
                                <CardBody className="grid grid-cols-3 place-items-center p-3">
                                    <Typography
                                        variant="paragraph"
