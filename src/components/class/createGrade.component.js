    ...
    async function addGrade() {
      try {
        ...
        if (Number.isInteger(parseInt(scale)) && !scale?.includes(".")) {
          gradeService
            .createGrade(classId, parseInt(scale), position, gradeName, user.id)
            .then(
              (res) => {
                if (res.status === 201) {
            ...
            <Form onSubmit={handleSubmit} ref={fref}>
              <div>
                <div className="form-group">
                  <label htmlFor="gradename" className="font-semibold mb-2">
                    Grade Name
                  </label>
                  <Input
                    type="text"
                ...
                <div className="form-group">
                  <label htmlFor="scale" className="font-semibold mb-2 mt-2">
                    Grade Scale(%)
                  </label>
                  <Input
                    type="number"
