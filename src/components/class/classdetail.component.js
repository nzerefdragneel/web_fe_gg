      ...
      try {
        ...
        if (isteacher.data.data === false) {
          ...
          try {
            ...
            console.error("Error checking have mssv:", error.message);
          }
        }
      } catch (error) {
  ...
  return (
    <div className="">
      ...
      <Tabs value={activeTab}>
        ...
        <TabsBody>
          ...
          <TabPanel key="assignment" value="assignment">
            {isteacher ? (
              ...
              <StudentTabAssignment id={classId}></StudentTabAssignment>
            )}
          </TabPanel>
        ...
        {classactive===0&& <div className="flex flex-col items-center justify-center h-full">
              <div className="text-3xl font-semibold text-gray-700">This class is not active</div>
              <div className="text-xl font-semibold text-gray-700">Please contact your teacher</div>
              <div className="text-xl font-semibold text-gray-700">Or contact admin</div>
              </div>
        }
